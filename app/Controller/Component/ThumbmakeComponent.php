...
class ThumbmakeComponent extends Component {
...
// 		$this->setMakeType = 'im'; //画像生成エンジンの選択 (GD/ImageMagick)
        $this->setMakeType = 'gd'; //画像生成エンジンの選択 (GD/ImageMagick)
...
//             return imageJpeg($this->dstImage,$this->dstPath,$this->quality);
        	$response = imageJpeg($this->dstImage,$this->dstPath,$this->quality);

        }elseif($this->imageType == 'image/gif'){

//             return imageGif($this->dstImage,$this->dstPath);
			$response = imageGif($this->dstImage,$this->dstPath);

        }elseif($this->imageType == 'image/png'){

//             return imagePng($this->dstImage,$this->dstPath);
			$response = imagePng($this->dstImage,$this->dstPath);
     ...
     * @static
     */
    public function setImage($srcPath, $dstPath) {
