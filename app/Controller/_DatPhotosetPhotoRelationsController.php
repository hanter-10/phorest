 ...
 */
	public function index() {
		...
		$group = array('group' => 'DatPhotoset.photoset_id');
		$conditions = array("DatPhotoset.photoset_id" => 1);

		$this->DatPhotosetPhotoRelation->recursive = 0;
		$datPhotosetPhotoRelations = $this->DatPhotosetPhotoRelation->find('all');
// 		$datPhotosetPhotoRelations = $this->DatPhotosetPhotoRelation->find('threaded', $group);
